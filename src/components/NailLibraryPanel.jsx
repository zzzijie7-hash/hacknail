  ...
  return (
    <BottomPanel open={open} onClose={onClose} title="美甲库">
      <div style={{ padding: `0 ${PAD}px` }}>
        ...
        {parseError && <p style={{ color: '#FF6B6B', fontSize: 11, marginBottom: 6 }}>{parseError}</p>}
        ...
        {allNails.length > 0 ? (
                  ...
                  return (
                    <div key={nail.id} onClick={() => onSelect(nail)}
                      ...
                      <div style={{
                        ...
                        outlineOffset: -1,
                        boxShadow: isSel ? '0 1px 31px rgba(131,242,223,0.3)' : undefined,
                      }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '40px 0', gap: 10 }}>
            ...
            <p style={{ fontSize: 13, color: 'rgba(0,0,0,0.2)', fontFamily: 'PingFang SC, sans-serif' }}>上传图片或粘贴链接添加款式</p>
          </div>
        )}
      </div>
    </BottomPanel>
